...
import "../uniswap/IERC721Permit.sol";
import "./IERC4906.sol";
import "../uniswap/IPeripheryPayments.sol";
import "../uniswap/IPeripheryImmutableState.sol";

/// @title Non-fungible token for positions
/// @notice Wraps CL positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
interface INonfungiblePositionManager_Aero is
    IPeripheryPayments,
